...
class TestBand:
    ...
    def test_name_is_mutable_string(self):
        ...
        # Raises exception when assigning non-string value to name
    ...
    def test_name_has_length(self):
        ...
        # Attempting to set an empty string to name should raise a TypeError
        with pytest.raises(TypeError):
            band_1.name = ""
    ...
    def test_hometown_is_immutable_string(self):
        ...
        # Attempting to change the hometown should raise an AttributeError
        with pytest.raises(AttributeError):
            band_1.hometown = "Boston"
        # Check that the hometown remains unchanged
        assert band_1.hometown == "NYC"
