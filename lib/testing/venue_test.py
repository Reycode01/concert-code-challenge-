...
class TestVenue:
    ...
    def test_name_has_length(self):
        ...
        # Raises exception when setting name to empty string
        with pytest.raises(TypeError):
            venue_1.name = ""
    ...
    def test_city_is_mutable_string(self):
        ...
        # Raises exception when assigning non-string value to city
        with pytest.raises(TypeError):
            venue_1.city = 7
    def test_city_has_length(self):
        ...
        # Raises exception when setting city to empty string
        with pytest.raises(TypeError):
            venue_1.city = ""
